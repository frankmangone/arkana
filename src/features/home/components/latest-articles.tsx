...
export function LatestArticles({
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full -mt-[200px] h-60 bg-gradient-to-b from-transparent to-background/80" />
        ...
        <div className="container z-10 mx-auto px-4 py-8 md:px-6 lg:px-8 max-w-8xl">
          ...
          <div className="text-center mt-8">
            <Link
              ...
              className="inline-block px-6 py-3 border-2 rounded-lg transition-colors hover:bg-[rgba(167,119,255,0.2)]"
            >
